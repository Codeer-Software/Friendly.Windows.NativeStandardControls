================================================================================
MICROSOFT FOUNDATION CLASS ライブラリ: NativeControls プロジェクトの概要
===============================================================================

アプリケーション ウィザードが作成した NativeControls には Microsoft 
Foundation Class の基本的な使い方が示されています。アプリケーション作成のひな型
としてお使いください。

このファイルには NativeControls アプリケーションを構成している各ファイ
ルの概要説明が含まれます。

NativeControls.vcxproj
...
NativeControls.vcxproj.filters
...
NativeControls.h
   ...
   CNativeControlsApp アプリケーション クラスを宣言します。

NativeControls.cpp
   これは、アプリケーション クラス CNativeControlsApp を含むメイン アプリケー
   ション ソース ファイルです。
...
res\NativeControls.ico
   これは、アプリケーションのアイコンとして使用されるアイコンファイルです。この
   アイコンはメイン リソース ファイル NativeControls.rc に含まれていま
   す。

res\NativeControls.rc2
...
NativeControlsDlg.h, NativeControlsDlg.cpp - ダイアログ
   これらのファイルは CNativeControlsDlg クラスを含みます。このクラスはアプ
   リケーションのメイン ダイアログの動作を定義します。ダイアログ テンプレートは
   Microsoft Visual C++ で編集可能な NativeControls.rc に含まれます。
...
StdAfx.h, StdAfx.cpp
   ...
   NativeControls.pch や既にコンパイルされた型のファイル StdAfx.obj を
   ビルドするために使用されます。
